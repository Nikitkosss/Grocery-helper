    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=100, unique=True, verbose_name='Уникальный юзернейм')),
        ...
        migrations.AddConstraint(
            model_name='subscriptions',
            constraint=models.CheckConstraint(check=models.Q(user=django.db.models.expressions.F('author')), name='Проверка самоподписки'),
        ),
    ]
